...
from loopy.parsing.TargetParser import NmapTargetParser, NessusTargetParser
...
def main():
    ...
    nmap_parser = NmapTargetParser(
        use_ips=True, 
        use_hosts=True
    )

    targets = nmap_parser.parse('./tests/nmap/nmap_localhost.xml')
